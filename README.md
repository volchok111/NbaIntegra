...
2. The loaded players are saved locally using Room
3. The list is shown on the screen
4. When the user opens player details, the app takes the player from local storage
5. When the user opens team details, the app takes team information about team from locally saved player data
